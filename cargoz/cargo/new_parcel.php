...
<div>
	<div class="card card-outline card-primary">
		<div class="card-body">
      <form action="" id="manage-parcel" class="row g-3">
        <input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
          <div class="container">
            <div class="col-lg-12 mb-4">
                <h5 class="mb-4 mt-4">Add Sender Information</h5>
                <div class="form-group row">
                  <div class="col-lg-4">
                      <label for="" class="mb-3">Name</label>
                      <input type="text" name="sender_name" id="" placeholder="Enter Full Name" class="form-control form-control-sm" value="<?php echo isset($sender_name) ? $sender_name : '' ?>" required>
                  </div>
                  <div class="col-lg-4">
                      <label for="" class="mb-3">Contact</label>
                      <input type="text" name="sender_contact" class="form-control" placeholder="Enter Contact Info" required="" value="<?php echo isset($sender_contact) ? $sender_contact : '' ?>">
                  </div>
                  <div class="col-lg-4">
                      <label for="" class="mb-3">Address</label>
                      <input type="text" name="sender_address" class="form-control" placeholder="Enter Address Info" value="<?php echo isset($sender_address) ? $sender_address : '' ?>" required="">
                  </div>
                </div>
            </div>
            <hr>
            <div class="col-lg-12 mb-4">
                <h5 class="mb-4 mt-4">Add Recipient Information</h5>
                <div class="form-group row">
                  <div class="col-lg-4">
                      <label for="" class="mb-3">Name</label>
                      <input type="text" name="recipient_name" id="" placeholder="Enter Full Name" class="form-control form-control-sm" value="<?php echo isset($recipient_name) ? $recipient_name : '' ?>" required>
                  </div>
                  <div class="col-lg-4">
                      <label for="" class="mb-3">Contact</label>
                      <input type="text" name="recipient_contact" id="" placeholder="Enter Contact Info" class="form-control form-control-sm" value="<?php echo isset($recipient_contact) ? $recipient_contact : '' ?>" required>
                  </div>
                  <div class="col-lg-4">
                      <label for="" class="mb-3">Address</label>
                      <input type="text" name="recipient_address" id="" placeholder="Enter Address Info" class="form-control form-control-sm" value="<?php echo isset($recipient_address) ? $recipient_address : '' ?>" required>
                  </div>
                </div>
            </div>
            <hr>
            <div class="col-lg-12 mb-4">
                <h5 class="mb-4 mt-4">Add Branch Information</h5>
                ...
                <div class="row" id="">
                  <?php if($_SESSION['login_branch_id'] <= 0): ?>
                    <div class="form-group col-6" id="fbi-field">
                      <label for="" class="control-label">Branch | Franchise Processed</label>
                  ...
                  <?php endif; ?>  
                  <div class="form-group col-6" id="tbi-field">
                    <label for="" class="control-label">Pickup | Franchise Branch</label>
              ...
              <hr>
              <div class="col-lg-12 mb-4">
                <h5 class="mb-4 mt-4">Add Parcel Information</h5>
...
<script>
  ...
  $('#new_parcel').click(function(){
    ...
    formData.append("email", "<?php echo $_SESSION['login_email']; ?>");
		$.ajax({
