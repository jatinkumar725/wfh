...
<table width="100%">
	<tr>
		<td colspan="3"><b>Tracking Number:</b> <?php echo $row['reference_number'] ?></td>
	</tr>
	<tr>
		<td width="33.33%">
			<p><b>Sender:</b> <?php echo ucwords($row['sender_name']); ?></p>
		</td>
		<td width="33.33%">
			<p><b>Recipient:</b> <?php echo ucwords($row['recipient_name']); ?></p>
		</td>
		<td width="33.33%"></td>
	</tr>
</table>
