...
<div>
	<div class="card card-outline card-primary">
		<div class="card-body">
			...
			<div class="alert text-danger text-center p-0 m-0 d-none">** Please Enter Tracking ID</div>
		</div>
	</div>
	<div class="row">
...
<script>
	function track_now(){
		...
		if(tracking_num === ''){
			$('.alert.text-danger').removeClass('d-none');
		}else{
			start_load();
			if (!$('.alert.text-danger').hasClass('d-none')) {
