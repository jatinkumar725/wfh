...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="callout callout-info" id="how_<?php echo str_replace(' ', '_', $sender_name);?>">
...
<button type="button" class="btn btn-primary" id="download_<?php echo str_replace(' ', '_', $sender_name);?>">Download PDF</button>
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
</div>
<script>
	document.getElementById("download_<?php echo str_replace(' ', '_', $sender_name);?>").addEventListener("click", function() {
		printJS({
			printable: document.querySelector("#uni_modal .modal-body").innerHTML,
			type: 'pdf',
			documentTitle: 'My Modal',
			targetStyles: ['*'],
...
<script>
	var value = "Name:<?php echo ucwords($sender_name) ?>, Address: <?php echo ucwords($sender_address) ?>, Contact: <?php echo ucwords($sender_contact) ?>";
